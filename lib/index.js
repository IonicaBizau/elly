 ...
 * @name elly
 * @function
 * @param {String|HTMLElement} input The element selector (e.g. `'#my-id > .my-class'`), the element tag you want to create (e.g. `'<ul>'`) or the HTML element (will be returned by the function).
